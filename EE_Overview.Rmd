...
## Python API
```{r, echo=FALSE, fig.align='center', out.width="1200px",fig.cap='Source: Tyler Erickson Geo4Good Earth Engine Python API slidedeck'}
   knitr::include_graphics('./PythonAPI_Image1.png')
```

## Python API
```{r, echo=FALSE, fig.align='center', out.width="1600px",fig.cap='Source: Tyler Erickson Geo4Good Earth Engine Python API slidedeck'}
...
```{r, echo=FALSE, fig.align='center', out.width="1000px",fig.cap='Source: Tyler Erickson Geo4Good Earth Engine Python API slidedeck'}
